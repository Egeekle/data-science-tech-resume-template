...
% CONTACT INFORMATION
%====================
\def\name{Edison Velazco} % Name Here
\def\phone{(305) 572-0088}
\def\city{Lima, PE}
\def\email{edisonvelazco@gmail.com}
\def\LinkedIn{edivel} % linkedin.com/in/______
\def\github{Egeekle} % github username
\def\role{Data Scientist / AI Junior Developer} % JOB TITLE
